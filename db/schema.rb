...
ActiveRecord::Schema[7.0].define(version: 2022_11_06_202541) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "examples", force: :cascade do |t|
    t.bigint "math_training_id", null: false
    t.text "example"
    ...
    t.index ["math_training_id"], name: "index_examples_on_math_training_id"
  end
  ...
  add_foreign_key "examples", "math_trainings"
